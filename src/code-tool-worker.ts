...
const fuse = new Fuse(
  [
    ...
    'client.autoimproveFix.answerQuestion',
    'client.autoimproveFix.cancel',
    'client.autoimproveFix.create',
    'client.autoimproveFix.dismiss',
    'client.autoimproveFix.getByID',
    'client.autoimproveFix.list',
    'client.autoimproveFix.promote',
    'client.autoimproveFix.sendGuidance',

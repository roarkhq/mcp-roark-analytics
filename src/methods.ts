...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.autoimproveJob.list',
    fullyQualifiedName: 'autoimproveJob.list',
    httpMethod: 'get',
    httpPath: '/v1/autoimprove/job',
  },
  {
    clientCallName: 'client.autoimproveJob.answerQuestion',
    fullyQualifiedName: 'autoimproveJob.answerQuestion',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/job/{jobId}/answer',
  },
  {
    clientCallName: 'client.autoimproveJob.cancel',
    fullyQualifiedName: 'autoimproveJob.cancel',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/job/{jobId}/cancel',
  },
  {
    clientCallName: 'client.autoimproveJob.dismiss',
    fullyQualifiedName: 'autoimproveJob.dismiss',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/job/{jobId}/dismiss',
  },
  {
    clientCallName: 'client.autoimproveJob.getByID',
    fullyQualifiedName: 'autoimproveJob.getByID',
    httpMethod: 'get',
    httpPath: '/v1/autoimprove/job/{jobId}',
  },
  {
    clientCallName: 'client.autoimproveJob.promote',
    fullyQualifiedName: 'autoimproveJob.promote',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/job/{jobId}/promote',
  },
  {
    clientCallName: 'client.autoimproveJob.sendGuidance',
    fullyQualifiedName: 'autoimproveJob.sendGuidance',
    httpMethod: 'post',

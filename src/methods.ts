...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.autoimproveFix.create',
    fullyQualifiedName: 'autoimproveFix.create',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/fix',
  },
  {
    clientCallName: 'client.autoimproveFix.list',
    fullyQualifiedName: 'autoimproveFix.list',
    httpMethod: 'get',
    httpPath: '/v1/autoimprove/fix',
  },
  {
    clientCallName: 'client.autoimproveFix.answerQuestion',
    fullyQualifiedName: 'autoimproveFix.answerQuestion',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/fix/{fixId}/answer',
  },
  {
    clientCallName: 'client.autoimproveFix.cancel',
    fullyQualifiedName: 'autoimproveFix.cancel',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/fix/{fixId}/cancel',
  },
  {
    clientCallName: 'client.autoimproveFix.dismiss',
    fullyQualifiedName: 'autoimproveFix.dismiss',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/fix/{fixId}/dismiss',
  },
  {
    clientCallName: 'client.autoimproveFix.getByID',
    fullyQualifiedName: 'autoimproveFix.getByID',
    httpMethod: 'get',
    httpPath: '/v1/autoimprove/fix/{fixId}',
  },
  {
    clientCallName: 'client.autoimproveFix.promote',
    fullyQualifiedName: 'autoimproveFix.promote',
    httpMethod: 'post',
    httpPath: '/v1/autoimprove/fix/{fixId}/promote',
  },
  {
    clientCallName: 'client.autoimproveFix.sendGuidance',
    fullyQualifiedName: 'autoimproveFix.sendGuidance',
    httpMethod: 'post',
